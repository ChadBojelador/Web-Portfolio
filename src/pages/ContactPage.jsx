...
const EMAILJS_PUBLIC_KEY  = 'get6yrAd5TK6qXwQf';
const RECIPIENT_EMAIL     = 'slsuls.chadbojelador@gmail.com';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(
        EMAILJS_SERVICE_ID,
        EMAILJS_TEMPLATE_ID,
        { ...formData, reply_to: formData.email, to_email: RECIPIENT_EMAIL },
        EMAILJS_PUBLIC_KEY
      );
